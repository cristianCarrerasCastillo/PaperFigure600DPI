# PaperFigure600DPI
Batch-convert images to 600 DPI, ready for scientific journals and publication workflows
...
- Download the latest `.exe` from the project's Releases page:
	...
	https://github.com/cristianCarrerasCastillo/PaperFigure600DPI/releases

	Or use the latest release direct link:

	https://github.com/cristianCarrerasCastillo/PaperFigure600DPI/releases/latest
...
```bash
git clone https://github.com/cristianCarrerasCastillo/PaperFigure600DPI
```
